...
function book({image, title, author, lang, pages}) { 

  return (
    <>
    <div  className='flex p-2 h-32 mt-4 bg-slate-700 rounded-lg justify-between' >
        <div className='flex '>
